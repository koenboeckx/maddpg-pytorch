...
class MADDPG:
    def __init__(self, args, agent_id):  # Because the obs and act dimensions of different agents may be different, the neural network is different, and agent_id is needed to distinguish
        self.args = args
    ...
    def train(self, transitions, other_agents):
        ...
        o, u, o_next = [], [], []  # Used to install the various items in each agent experience
        ...
        actor_loss = - self.critic_network(o, u).mean() # consistent with Deterministic Policy Gradient Algorithms [Silver et al, '14]
        # if self.agent_id == 0:
